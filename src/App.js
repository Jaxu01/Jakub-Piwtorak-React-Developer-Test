...
function App() {
  ...
  const handleActiveCurrencyProducts = (products) => {
    ...
    products.forEach(product => {
      const activePrice = product.prices.find(price => price.currency.label === currency)
      product.activePrice = activePrice
      productList.push({
        price: activePrice,
        ...product
      })
 ...
 const fetchData = async() => {
    ...
    category.products = handleActiveCurrencyProducts(category.products)
        ...
        <header className="desktop">
          <nav className="navigation">
            ...
            <div className="section-middle">
              <svg className="logo" width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="section-right">
                <Currencies setCurrency={handleCurrency}/>
              <svg className="shopcart" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
